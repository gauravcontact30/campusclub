...
export function Hero({ businessCount, cityCount }: { businessCount: number; cityCount: number }) {
  return (
    <section className="relative overflow-hidden bg-noir text-pearl">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -right-24 -top-32 h-[520px] w-[520px] rounded-full bg-rouge/25 blur-[120px]"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -bottom-40 -left-20 h-[420px] w-[420px] rounded-full bg-blush/20 blur-[120px]"
      />
