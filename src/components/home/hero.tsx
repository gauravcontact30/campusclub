...
export function Hero({ businessCount, cityCount }: { businessCount: number; cityCount: number }) {
  return (
    <section className="relative overflow-hidden bg-canvas text-content">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -right-24 -top-32 h-[520px] w-[520px] rounded-full bg-ember/25 blur-[120px]"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute -bottom-40 -left-20 h-[420px] w-[420px] rounded-full bg-marigold/20 blur-[120px]"
      />
      ...
      <div className="container-page relative grid gap-14 py-16 sm:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:py-28">
        <div className="animate-fade-up">
          ...
          <h1 className="display-xl mt-6 text-content">
            Meet five strangers.
            <br />
            <span className="text-ember">Find your city.</span>
          </h1>
