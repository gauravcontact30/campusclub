      ...
      <div className="container-page">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <dl className="mt-9 grid grid-cols-2 gap-6 border-t border-cream/15 pt-8 sm:grid-cols-3">
              {[
                ['92%', 'would come again'],
                ['6', 'seats per table'],
                ...
                <div key={label}>
                  <dt className="font-display text-3xl font-semibold text-flame">{stat}</dt>
                  <dd className="mt-1 text-sm text-cream/60">{label}</dd>
                </div>
              ))}
            </dl>
          ...
          <div className="grid gap-4 text-ink sm:grid-cols-2">
