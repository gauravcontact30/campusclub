  ...
  if (done) {
    return (
      <div className="surface-card p-8 text-center sm:p-12">
        <span className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-marigold/25 text-content">
          <Check size={30} />
        </span>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  active ? 'border-ember bg-ember text-content' : 'border-content/15 bg-canvas-700 hover:border-content/40',
                )}
              >
                <span className="flex items-center justify-between gap-3">
                  ...
                  <span
                    className={cn(
                      ...
                      active ? 'border-ember bg-ember text-content' : 'border-content/25',
                    )}
                  >
      ...
      <div className="mt-9 flex items-center justify-between gap-3">
        ...
        {index < total - 1 ? (
          ...
          <Link
            ...
            className="inline-flex h-14 items-center rounded-full bg-ember px-8 font-semibold text-content hover:bg-ember-600"
          >
        ...
        {QUIZ_QUESTIONS.map((q, i) => (
          <button
            ...
            className={cn(
              ...
              i === index ? 'w-8 bg-content' : (answers[q.id] ?? merged[q.id]) ? 'w-4 bg-ember' : 'w-4 bg-content/15',
            )}
          />
        ))}
      </div>
