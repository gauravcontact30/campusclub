      ...
      <fieldset>
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {AMENITIES.map((amenity) => (
            <label
              key={amenity}
              className="cursor-pointer rounded-full border border-content/15 px-3.5 py-2 text-xs font-medium transition-colors has-[:checked]:border-ember has-[:checked]:bg-ember has-[:checked]:text-content"
            >
