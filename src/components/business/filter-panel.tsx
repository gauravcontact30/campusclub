      ...
      <div className="mt-6 space-y-6">
        ...
        <label className="flex cursor-pointer items-center justify-between gap-3 rounded-2xl border border-content/15 px-4 py-3">
          ...
          <input
            ...
            className="h-5 w-9 cursor-pointer appearance-none rounded-full bg-content/20 transition-colors checked:bg-rouge relative after:absolute after:left-0.5 after:top-0.5 after:h-4 after:w-4 after:rounded-full after:bg-canvas after:transition-transform checked:after:translate-x-4"
          />
        </label>
        ...
        <div>
          ...
          <button
            ...
            className={cn(
              ...
              query.near ? 'border-rouge bg-rouge/10 text-rouge-700' : 'border-content/15 hover:border-content/45',
            )}
          >
          ...
          {query.near && (
            <button
              ...
              className="mt-2 text-xs font-semibold text-content/55 hover:text-rouge"
            >
              Clear location
            </button>
          )}
