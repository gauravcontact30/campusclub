...
export default async function PricingPage() {
  ...
  return (
    <>
      <section className="bg-noir py-16 text-pearl sm:py-20">
        <div className="container-page max-w-3xl text-center">
          <p className="eyebrow">Membership</p>
          <h1 className="display-lg mt-3 text-pearl">Pay for the table, not the app.</h1>
          <p className="lede mx-auto mt-5 max-w-xl text-pearl/70">
