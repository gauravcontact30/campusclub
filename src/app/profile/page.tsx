        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              <Badge tone="rouge">{plan.name}</Badge>
              {quiz ? <Badge tone="blush">Match-ready</Badge> : <Badge>Quiz not taken</Badge>}
            </div>
          </div>
        </div>
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_1.3fr]">
        <div className="space-y-6">
          ...
          <div className="surface-card p-6">
            <div className="flex items-center justify-between gap-3">
              ...
              <Link href="/add-business" className="text-sm font-semibold text-rouge-700 hover:underline">
                Add one
              </Link>
            </div>
              ...
              <ul className="mt-4 space-y-3">
                {managed.map((business) => (
                  <li key={business.id} className="flex items-center justify-between gap-3">
                    ...
                    <Badge tone="blush">Claimed</Badge>
                  </li>
                ))}
              </ul>
            )}
          ...
          <div className="surface-card p-6">
            ...
            {quiz ? (
              <>
                ...
                <Link href="/dinners/quiz" className="mt-5 inline-block text-sm font-semibold text-rouge-700 hover:underline">
        ...
        <div className="surface-card p-6">
          <div className="flex items-center justify-between">
            ...
            <Link href="/businesses" className="text-sm font-semibold text-rouge-700 hover:underline">
              Write another
            </Link>
          </div>
                  ...
                  <li key={review.id} className="py-4">
                    <div className="flex items-center justify-between gap-3">
                      <Link
                        ...
                        className="font-semibold hover:text-rouge"
                      >
